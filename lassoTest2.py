    ...
    def mousePressEvent(self, event):
        if event.button() == QtCore.Qt.LeftButton:
            if self.is_first_click_of_selection == True:
                ...
                self.current_point =  event.position().toPoint()
                if (self.current_point.x() - self.initial_point.x()) < 150 and (self.current_point.y() - self.initial_point.y() < 150) and (self.current_point.x() - self.initial_point.x()) > -150 and (self.current_point.y() - self.initial_point.y() > -150):
