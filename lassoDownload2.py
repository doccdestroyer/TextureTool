...
class MainWindow(QMainWindow):
    def __init__(self, image_path):
        ...
        self.yellow_blue_panel = Slider(self, "Colour Balance - Blue " , 1, 100, 50)
        self.yellow_blue_panel.show()
    ...
    def adjust_blueness(self,value):
        ...
        self.yellow_blue_panel.image_label.setPixmap(QPixmap.fromImage(image))
